...
You can test locally you job using local input data by using Run Locally feature, and compile the scrpit usin compile feature to generate the ARM template.
